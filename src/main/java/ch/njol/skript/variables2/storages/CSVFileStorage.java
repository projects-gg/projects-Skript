...
import ch.njol.skript.variables2.FileStorageConfiguration;
import ch.njol.skript.variables2.VariableFileStorage;
 ...
 */
public class CSVFileStorage extends VariableFileStorage {

	private final static Charset UTF_8 = Charset.forName("UTF-8");

	@Override
	public void loadConfiguration(FileStorageConfiguration configuration) {
	...
	@Override
	@Nullable
	public Object getVariable(String name, @Nullable Event event, boolean local) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public void setVariable(String name, @Nullable Event event, boolean local, @Nullable Object value) {
		// TODO Auto-generated method stub
